...
// Fetching separate lists for cleaner UI
...
<div class="dashboard-grid" style="margin-top: 2.5rem; align-items: stretch;">
    <div class="skill-card-main">
        ...
        <div class="ai-upload-box">
            <p style="font-size: 0.85rem; color: #64748b; margin-bottom: 1.5rem;">Upload PDF to sync skills.</p>
            <form id="resumeForm">
        ...
        <div id="aiResults" style="display:none; margin-top:1.5rem;">
            <div id="aiSkillTags" class="tag-container" style="margin-bottom:1rem;"></div>
            <button class="btn-skill" onclick="saveAISkills()">Verify & Save</button>
        </div>
    </div>
    ...
    <div class="skill-card-main">
        ...
        <form id="manualSkillForm">
            <div style="margin-bottom:15px;">
                <label style="font-size:0.7rem; font-weight:800; color:#94a3b8; text-transform:uppercase;">Skill</label>
            ...
            <button type="submit" class="btn-skill"><i class="fas fa-plus-circle"></i> Add Skill</button>
        </form>
    </div>
...
<script>
// Logic remains same, location.reload() keeps the lists updated
...
// AI and Manual form logic (summarized for brevity)
